...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice This function working assumes the protocol will be roughly 150% overcollatarized in order for this to work.
     * @notice A known bug would be if the protocol was only 100% collateralized, we woudn't be able to liquidate anyone.
